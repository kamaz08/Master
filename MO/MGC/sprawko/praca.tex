...
% Tytuł pracy
				\put(80,320){\Huge \textsc{Metody optymalizacji}}
				\put(80,280){\Huge \textsc{Minimum Graph Coloring}}
% Autor pracy
				\put(90,200){\makebox(0,0)[l]{\large \textsc{Kamil Sikorski}}}
				\put(90,180){\makebox(0,0)[l]{\large \textsc{Nr indeksu: 221481}}}

				\put(200,100){\makebox(0,0)[l]{\large Przedmiot prowadzony przez}}
% dane promotora
				\put(200,60){\makebox(0,0)[l]{\large Pawła Zielińskiego}}
