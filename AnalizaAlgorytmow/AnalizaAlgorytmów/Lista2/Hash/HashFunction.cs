...
namespace Lista2.Hash
{
    ...
    {
        double GetHash(int n);
    }
    public class Sha256Function : IHashFunction
    {
        SHA256 _sHA256;
        ...
        public double GetHash(int n)
        {
            var bytes = BitConverter.GetBytes(n);
            var hash = _sHA256.ComputeHash(bytes);
            return HashElement.GetPropability(hash);
        }
    }

    public class Md5Function : IHashFunction
    {
        MD5 _md5;
        public Md5Function()
        {
    ...
    public class Crc64Function : IHashFunction
    {
        ...
        public double GetHash(int n)
        {
            ...
            return HashElement.GetPropability(new byte[]
            {
